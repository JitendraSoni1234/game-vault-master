...
function Card({ id, title, thumbnail, short_description, publisher, release_date }) {
  return (
    <Link to={`/${id}`} className='p-4 lg:w-1/4 md:w-1/2 shadow-lg dark:bg-gray-900 bg-white hover:scale-110 transition ease-in-out rounded-lg duration-700'>
      <div className='h-full flex flex-col items-center text-center'>
        ...
        <div className='w-full'>
          ...
          <h3 className='dark:text-white mb-3'>{publisher} - {release_date}</h3>
