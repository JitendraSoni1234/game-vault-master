    ...
    <Link to={`/${id}`} className='p-4 xl:w-1/4 lg:w-1/2 w-full shadow-lg dark:bg-gray-900 bg-white lg:hover:scale-105 transition ease-in-out rounded-lg duration-700'>
      <div className='h-full flex flex-col items-center text-center'>
        <div className='relative mb-4 w-full'>
          ...
          <div className='absolute inset-0 bg-black opacity-0 hover:opacity-70 text-transparent hover:text-white text-3xl flex place-items-center justify-center'>{title}</div>
        </div>
